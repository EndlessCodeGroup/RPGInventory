...
#-repackageclasses shadow.com.example.myplugin

## We need to keep entry points to the plugin.
## Also here you should add your api classes that can be used by others plugins.
-keep public class com.example.myplugin.MyPlugin
#-keep class com.example.myplugin.MyApi
